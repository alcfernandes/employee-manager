...
INSTALLED_APPS = [
    ...
    # Necessário para upload de arquivos pelo front.
    'corsheaders',
...
if USE_S3:
    ...
    AWS_QUERYSTRING_AUTH = False  # shows path without hashs
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'employee.core.util.drf.exception_handler',
...
# Django-cors-headers. To allow API access from another domains.
